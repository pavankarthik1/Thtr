...
##        self.loadDir()
    ...
    def loadDir(self, dbg = False):
        ...
        self.imageDir = os.path.join('/home/pavan/Downloads/WordSegmentation-20200430T050819Z-001/bounding_box-20200505T045842Z-001/bounding_box/images/', str(self.imgclass))
        print(self.imageDir)
        ...
        self.total = len(self.imageList)
         ...
         # set up output dir
        self.outDir = os.path.join('/home/pavan/Downloads/WordSegmentation-20200430T050819Z-001/bounding_box-20200505T045842Z-001/bounding_box/labels', str(self.imgclass))

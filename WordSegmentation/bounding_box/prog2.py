...
##        self.loadDir()
    ...
    def loadDir(self, dbg = False):
        ...
        self.imageDir = os.path.join('E:\pytorch_objectdetecttrack-master\data\images', str(self.imgclass))
        print(self.imageDir)
        ...
        self.total = len(self.imageList)
         ...
         # set up output dir
        self.outDir = os.path.join('E:\pytorch_objectdetecttrack-master\data\labels', str(self.imgclass))
